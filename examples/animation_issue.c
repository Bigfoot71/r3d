...
int main(void)
{
    ...
    R3D_SetAnimationWeight(&modelPlayer, 3, 1.0f);
    R3D_SetAnimationLoop(&modelPlayer, 3, true);
    R3D_SetAnimationSpeed(&modelPlayer, 3, 0.2f);
    R3D_PlayAnimation(&modelPlayer, 3);

    R3D_SetAnimationWeight(&modelPlayer, 4, 1.0f);
    R3D_SetAnimationLoop(&modelPlayer, 4, true);
    R3D_SetAnimationSpeed(&modelPlayer, 4, 0.2f);
    R3D_PlayAnimation(&modelPlayer, 4);
