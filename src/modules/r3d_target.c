...
static const target_config_t TARGET_CONFIG[] = {
    ...
    [R3D_TARGET_NORMAL]      = { FORMAT_RG16U,   1.0f,  GL_NEAREST,              GL_NEAREST, 3, {0} },
    [R3D_TARGET_ORM]         = { FORMAT_RGB8U,   1.0f,  GL_NEAREST,              GL_NEAREST, 2, {0} },
    [R3D_TARGET_DEPTH]       = { FORMAT_R16F,    1.0f,  GL_NEAREST,              GL_NEAREST, 3, {65504.0f, 65504.0f, 65504.0f, 65504.0f} },
    [R3D_TARGET_DIFFUSE]     = { FORMAT_RGB16F,  1.0f,  GL_NEAREST,              GL_NEAREST, 3, {0} },
    ...
    [R3D_TARGET_SSGI_0]      = { FORMAT_RGB16F,  0.25f, GL_LINEAR,               GL_LINEAR,  1, {0} },
    [R3D_TARGET_SSGI_1]      = { FORMAT_RGB16F,  0.25f, GL_LINEAR,               GL_LINEAR,  1, {0} },
    [R3D_TARGET_SSGI_2]      = { FORMAT_RGB16F,  0.25f, GL_LINEAR,               GL_LINEAR,  1, {0} },
